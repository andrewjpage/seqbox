...
from app.models import ArticCovidResult
from seqbox_utils import  read_in_artic_covid_result, check_artic_covid_result, add_artic_covid_result, get_artic_covid_result, add_raw_sequencing_batch,get_nanopore_readset_from_batch_and_barcode, add_extraction, add_tiling_pcr, add_group, add_project, add_sample_source, add_sample, add_readset_batch, add_readset
...
class TestSeqboxUtilsArticWorkflows(TestCase):
    ...
    def populate_db(self, temp_dir):
        ...
        add_readset({'data_storage_device': 'storage_device_1', 'readset_batch_name': 'EFG', 'date_extracted': '01/01/2023', 'extraction_identifier': '1','sample_identifier': 'sample1','group_name': 'Group','date_tiling_pcred': '01/01/2023','tiling_pcr_identifier':'5','path_fastq': temp_fastq_file,'path_fast5': temp_fast5_file}, True, False)
