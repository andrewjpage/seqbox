...
python src/scripts/seqbox_filehandling.py add_readset_to_filestructure -i test/01.test/sequencing_tracker.xlsx -c test/test_seqbox_config.yaml -s -n
...
python src/scripts/seqbox_filehandling.py add_artic_consensus_to_filestructure -b 20201201_1355_MN33881_FAO20804_109641e0 -c test/test_seqbox_config.yaml -d /Users/flashton/Dropbox/non-project/test_seqbox_data/fast/inbox/20201201_1355_MN33881_FAO20804_109641e0/work